    ...
    return (
        (n.prototype.registerDocNodes = function (e, t) {
            ...
            for (var i = 0, o = t; i < o.length; i++) {
                ...
                if (
                    ((l = this._docNodeDefinitionsByConstructor.get(
                        a.constructor,
                    )),
                    l !== void 0)
                )
                ...
                (this._docNodeDefinitionsByKind.set(a.docNodeKind, c),
                    this._docNodeDefinitionsByConstructor.set(
                        a.constructor,
                        c,
                    ));
            }
        ...
        (n.prototype.registerAllowableChildren = function (e, t) {
            for (
                var r = this._getDefinition(e), i = 0, o = t;
                i < o.length;
                i++
            ) {
                var a = o[i];
...
var T = (function () {
    ...
    return (
        (n.prototype.getChildNodes = function () {
            return (
                this.configuration.docNodeManager.throwIfNotRegisteredKind(
                    this.kind,
                ),
...
(function (n) {
    ((n.ConfigFileNotFound = "tsdoc-config-file-not-found"),
        ...
        (n.InheritDocIncompatibleSummary =
        ...
        (n.ReferenceMalformedImportPath =
        ...
        (n.ReferenceMissingRightBracket =
    ...
    return (
        ...
        (n.prototype.addTagDefinition = function (e) {
            ...
            if (t !== e) {
                if (t)
                    throw new Error(
                        "A tag is already defined using the name ".concat(
                            t.tagName,
                        ),
                    );
        ...
        (n.prototype.addTagDefinitions = function (e, t) {
            for (var r = 0, i = e; r < i.length; r++) {
                var o = i[r];
                (this.addTagDefinition(o),
                    t !== void 0 && this.setSupportForTag(o, t));
            }
        }),
    ...
    ar = (function (n) {
        ...
        return (
            ...
            (e.prototype.appendNode = function (t) {
                if (
                    !this.configuration.docNodeManager.isAllowedChild(
                        this.kind,
                        t.kind,
                    )
                )
...
(function (n) {
    ((n.Spacing = "Spacing"),
        ...
        (n.DeclarationReference_PackageName =
        ...
        (n.MemberReference_RightParenthesis =
                    ...
                    case g.InheritDocTag:
                        ...
                        this._renderInlineTag($, function () {
                            $.declarationReference &&
                                (t._writeContent(" "),
                                t._renderNode($.declarationReference));
                        });
                        break;
                    case g.InlineTag:
                        var K = e;
                    ...
                    case g.LinkTag:
                        ...
                        this._renderInlineTag(D, function () {
                            ((D.urlDestination !== void 0 ||
                                ...
                                (D.urlDestination !== void 0
                                    ? (t._writeContent(" "),
                                      t._writeContent(D.urlDestination))
                                    : D.codeDestination !== void 0 &&
                                      (t._writeContent(" "),
                                      t._renderNode(D.codeDestination))),
                                D.linkText !== void 0 &&
                                    (t._writeContent(" "),
                                    t._writeContent("|"),
                                    t._writeContent(" "),
            ...
            if (!(e === void 0 || e.length === 0)) {
                ...
                if (t.length > 1) {
                    for (var r = !0, i = 0, o = t; i < o.length; i++) {
                        var a = o[i];
                        (r ? (r = !1) : this._writeNewline(),
                            this._writeContent(a));
                    }
                    return;
                }
                (this._lineState === he.Closed &&
        ...
        function e(t) {
            ...
            return (
                T.isParsedParameters(t)
                    ...
                    : ((i._packageName = t.packageName),
                      (i._importPath = t.importPath)),
                (i._memberReferences = []),
                t.memberReferences &&
                ...
                get: function () {
                    return (
                        this._packageName === void 0 &&
                            ...
                            (this._packageName =
                                this._packageNameExcerpt.content.toString()),
                        this._packageName
                    );
                },
                enumerable: !1,
                ...
                get: function () {
                    return (
                        this._importPath === void 0 &&
                            ...
                            (this._importPath =
                                this._importPathExcerpt.content.toString()),
                        this._importPath
                    );
                },
                enumerable: !1,
            ...
            get: function () {
                return (
                    this._encodedText === void 0 &&
                        (this._encodedText =
                            this._encodedTextExcerpt.content.toString()),
                    this._encodedText
                );
            },
            enumerable: !1,
                    ...
                    return (
                        this._language === void 0 &&
                            (this._languageExcerpt !== void 0
                                ? (this._language =
                                      this._languageExcerpt.content.toString())
                                : (this._language = "")),
                        this._language
                    );
                },
            ...
            Object.defineProperty(e.prototype, "value", {
                get: function () {
                    return (
                        this._value === void 0 &&
                            (this._value =
                                this._valueExcerpt.content.toString()),
                        this._value
                    );
                },
                enumerable: !1,
        ...
        function e(t) {
            ...
            return (
                T.isParsedParameters(t)
                    ...
                    : ((i._name = t.name),
                      (i._spacingAfterName = t.spacingAfterName)),
                (i._htmlAttributes = []),
                t.htmlAttributes &&
                ...
                get: function () {
                    if (this._tagContent === void 0)
                        if (this._tagContentExcerpt)
                            this._tagContent =
                                this._tagContentExcerpt.content.toString();
                        else return "";
    ...
    er = (function (n) {
        ...
        function e(t) {
            ...
            if (r.tagNameWithUpperCase !== "@LINK")
                throw new Error(
                    'DocLinkTag requires the tag name to be "{@link}"',
                );
            if (
                ((r._codeDestination = t.codeDestination),
                T.isParsedParameters(t))
            ) {
                if (
                    t.codeDestination !== void 0 &&
                    t.urlDestinationExcerpt !== void 0
                )
                    throw new Error(
                ...
                ((r._urlDestination = t.urlDestination),
                    (r._linkText = t.linkText));
            }
            return r;
        }
        return (
                ...
                get: function () {
                    return (
                        this._linkText === void 0 &&
                            ...
                            (this._linkText =
                                this._linkTextExcerpt.content.toString()),
                        this._linkText
                    );
                },
                enumerable: !1,
                ...
                get: function () {
                    return (
                        this._identifier === void 0 &&
                            (this._identifier =
                                this._identifierExcerpt.content.toString()),
                        this._identifier
                    );
                },
                enumerable: !1,
            ...
            return (
                ...
                T.isParsedParameters(t) &&
                    ...
                    t.unsupportedJsdocTypeBeforeParameterNameExcerpt &&
                        (r._unsupportedJsdocTypeBeforeParameterNameExcerpt =
                            new j({
                                configuration: r.configuration,
                    ...
                    t.unsupportedJsdocOptionalNameOpenBracketExcerpt &&
                        (r._unsupportedJsdocOptionalNameOpenBracketExcerpt =
                            new j({
                                configuration: r.configuration,
                                excerptKind: y.NonstandardText,
                                content:
                    ...
                    t.unsupportedJsdocTypeAfterParameterNameExcerpt &&
                        (r._unsupportedJsdocTypeAfterParameterNameExcerpt =
                            new j({
                                configuration: r.configuration,
                                excerptKind: y.NonstandardText,
                                content:
...
`
        ...
        (n.prototype._validateBounds = function () {
            ...
            if (this.end < this.pos)
                throw new Error(
                    "TextRange.end cannot be smaller than TextRange.pos",
                );
    ...
    return (
        (n._formatMessageText = function (e, t) {
            if (
                ...
                if (r.line)
                    return "(".concat(r.line, ",").concat(r.column, "): ") + e;
            }
            return e;
        }),
...
var Hr = (function () {
    ...
    return (
        ...
        (n.prototype.addMessageForTextRange = function (e, t, r) {
            this.addMessage(
                new _n({ messageId: e, messageText: t, textRange: r }),
            );
        }),
    ...
    return (
        (n.readTokens = function (e) {
            ...
            return (
                r
                    ? t.push(
                          new Nt(u.EndOfInput, r.getNewRange(r.end, r.end), r),
                      )
        ...
        (n._pushTokensForLine = function (e, t) {
            for (
                var r = t.buffer, i = t.end, o = t.pos, a = void 0, l = o;
                o < i;
            ) {
                ...
                (d === void 0 && (d = u.Other),
                    (a !== void 0 && d === a && n._isMultiCharacterToken(a)) ||
                        (a !== void 0 &&
                            e.push(new Nt(a, t.getNewRange(l, o), t)),
                        (l = o),
                        (a = d)),
                    ++o);
            }
...
` + JSON.stringify(t),
        ...
        (n.prototype.backtrackToMarker = function (e) {
            ...
            ((this._currentIndex = e),
                e < this._accumulatedStartIndex &&
                    (this._accumulatedStartIndex = e));
        }),
        n
    );
})();
...
var io = (function () {
    ...
    return (
                    ...
                    case u.LeftCurlyBracket: {
                        ...
                        if (i instanceof gn) {
                            ...
                            o.inheritDocTag === void 0
                                ? (this._parserContext.docComment.inheritDocTag =
                                      i)
                                : this._pushNode(
        ...
        (n.prototype._parseAndPushBlock = function (e) {
            ...
            if (
                ...
                switch (l.syntaxKind) {
                    case R.BlockTag:
                        if (
                            a.tagNameWithUpperCase ===
                            G.param.tagNameWithUpperCase
                        ) {
                            var c = this._parseParamBlock(
                                e,
                                a,
                                G.param.tagName,
                            );
                            ...
                            a.tagNameWithUpperCase ===
                            G.typeParam.tagNameWithUpperCase
                        ) {
                            var c = this._parseParamBlock(
                                e,
                                a,
        ...
        (n.prototype._parseParamBlock = function (e, t, r) {
            ...
            if (l) {
                ...
                (S &&
                    (k = t
                        .getTokenSequence()
                        .getNewSequence(l.startIndex, S.endIndex)),
                    this._parserContext.log.addMessageForTokenSequence(
        ...
        (n.prototype._pushNode = function (e) {
            this._configuration.docNodeManager.isAllowedChild(
                g.Paragraph,
                e.kind,
            )
        ...
        (n.prototype._parseInlineTag = function (e) {
            ...
            for (var m = !1; !m; )
                switch (e.peekTokenKind()) {
                    ...
                    case u.Backslash:
                        if (
                            (e.readToken(),
                            !xn.isPunctuation(e.peekTokenKind()))
                        ) {
            ...
            var O =
                this._parserContext.configuration.tryGetTagDefinitionWithUpperCase(
                    S,
                );
        ...
        (n.prototype._parseLinkTag = function (e, t) {
            ...
            if ((t.backtrackToMarker(a), o)) {
                if (
                    !this._parseLinkTagUrlDestination(t, i, e.tagNameExcerpt, r)
                )
                    return r;
            } else if (
                !this._parseLinkTagCodeDestination(t, i, e.tagNameExcerpt, r)
            )
                return r;
            if (t.peekTokenKind() === u.Spacing)
                throw new Error(
                    "Unconsumed spacing encountered after construct",
                );
            if (t.peekTokenKind() === u.Pipe) {
                (t.readToken(),
                    (i.pipeExcerpt = t.extractAccumulatedSequence()),
                    (i.spacingAfterPipeExcerpt =
                        this._tryReadSpacingAndNewlines(t)),
                    (l = !1));
                for (var c = void 0; !l; )
                    switch (t.peekTokenKind()) {
                        case u.EndOfInput:
                ...
                m &&
                    (c === void 0
                        ...
                        : c >= m.endIndex
                          ? (i.linkTextExcerpt = m)
                          : ((i.linkTextExcerpt = m.getNewSequence(
                                m.startIndex,
                                c,
                            )),
        ...
        (n.prototype._parseMemberReference = function (e, t, r, i) {
            ...
            if (
                ...
                if (
                    ((o.memberSymbol = this._parseMemberSymbol(e, i)),
                    !o.memberSymbol)
                )
                    return;
            } else if (
            ...
            if (
                ...
                if (
                    ((o.selector = this._parseMemberSelector(
                        e,
                        o.colonExcerpt,
                        i,
                    )),
        ...
        (n.prototype._parseHtmlName = function (e) {
            ...
            return a
                ? this._createFailureForTokensSince(
                      e,
                      v.MalformedHtmlName,
                      a,
                      t,
                  )
                : this._configuration.validation
        ...
        (n.prototype._parseFencedCode = function (e) {
            ...
            for (
                ...
                e.readToken();
            for (
                var a = e.tryExtractAccumulatedSequence(), l = !1, c = void 0;
                !l;
            )
                switch (e.peekTokenKind()) {
                    case u.Spacing:
        ...
        (n.prototype._parseCodeSpan = function (e) {
            ...
            e.readToken();
            for (
                var r = e.extractAccumulatedSequence(), i = void 0, o = void 0;
                ;
            ) {
        ...
        (n.prototype._backtrackAndCreateErrorRange = function (e, t, r, i, o) {
            for (e.backtrackToMarker(t); e.createMarker() !== r; )
                e.readToken();
        ...
        (n.prototype._backtrackAndCreateErrorForFailure = function (
            e,
            t,
            r,
            i,
...
function Le(n) {
    for (var e = Z(n), t = ho(n); t && Vr(t) && we(t).position === "static"; )
        t = ho(t);
    return t &&
    ...
    if (!!F) {
        if (o) {
            var f,
                ...
                tt = Lt(0, J[_e], B[_e]),
                W = K
                    ? J[_e] / 2 - Yt - tt - q - Q.mainAxis
                    : Ue - tt - q - Q.mainAxis,
                je = K
                    ? -J[_e] / 2 + Yt + tt + ee + Q.mainAxis
                    : et + tt + ee + Q.mainAxis,
        ...
        if (l) {
            var On,
                ...
                se =
                    b && pn ? Ao(Ln, it, Ge) : Lt(b ? Ln : Fn, it, b ? Ge : qn);
            ((F[H] = se), (C[H] = se - it));
        }
        e.modifiersData[r] = C;
    }
                        ...
                        if (!!Po($, K)) {
                            ((m.rects = {
                                ...
                                m.orderedModifiers.forEach(function (Q) {
                                    return (m.modifiersData[Q.name] =
                                        Object.assign({}, Q.data));
                                }));
                            for (
                                var D = 0;
                                D < m.orderedModifiers.length;
                                D++
                            ) {
                                if (m.reset === !0) {
                                    ((m.reset = !1), (D = -1));
        ...
        constructor(e, t, r) {
            ((this.owner = e),
                ...
                r.register([], "ArrowUp", (i) => {
                    if (!i.isComposing)
                        return (
                            this.setSelectedItem(this.selectedItem - 1, !0),
                            !1
                        );
                }),
                            ...
                            (new on(o.inputEl, this.plugin, $e.TemplateFiles),
                                o
                                    ...
                                    .onChange((a) => {
                                        ...
                                        ((this.plugin.settings.startup_templates[
                                            r
                                        ] = a),
                                            this.plugin.save_settings());
                                    }),
                    ...
                    (l.addClass("templater_title"),
                        new L.Setting(this.containerEl)
                            ...
                            .addText((d) => {
                                ...
                                return (
                                    m.inputEl.addClass("templater_template"),
                                    m
                                );
                            })
                            .addTextArea((d) => {
    ...
    getItemText(e) {
        ...
        if (
            ...
            let r = this.plugin.settings.templates_folder.length,
                i = this.plugin.settings.templates_folder.endsWith("/")
                    ? r
                    : r + 1;
            t = e.path.slice(i);
        }
    ...
    pi = class extends be {
        ...
        generate_include() {
            return async (e) => {
                ...
                let t;
                if (e instanceof le.TFile)
                    t = await this.plugin.app.vault.read(e);
                else {
                    let r;
                    ...
                    let { path: i, subpath: o } = (0, le.parseLinktext)(r[1]),
                        a = this.plugin.app.metadataCache.getFirstLinkpathDest(
                            i,
                            "",
                        );
                    if (!a)
        ...
        generate_path() {
            return (e = !1) => {
                ...
                if (le.Platform.isMobile) {
                    ...
                    this.plugin.app.vault.adapter instanceof
                    le.FileSystemAdapter
                )
            ...
            try {
                ...
                return t && i
                    ? t.split(".").reduce((o, a) => {
                          ...
                          throw new Error(
                              `Path ${t} not found in the JSON response`,
                          );
                      }, i)
                    : i;
            } catch (r) {
                throw (
                    console.error(r),
                    new P("Error fetching and extracting value")
                );
            }
        };
    }
...
var mi = class extends Qe.Modal {
    ...
    createForm() {
        ...
        (i.buttonEl.addClass("mod-cta"),
            ...
            t.inputEl.focus(),
            t.inputEl.addEventListener("keydown", (o) =>
                this.enterCallback(o),
            ));
    }
    enterCallback(e) {
        e.isComposing ||
    ...
    gi = class extends Uo.FuzzySuggestModal {
        ...
        getItemText(e) {
            return this.text_items instanceof Function
                ? this.text_items(e)
                : this.text_items[this.items.indexOf(e)] ||
                      "Undefined Text Item";
        }
        onChooseItem(e) {
            this.resolve(e);
...
var yi = class {
    constructor(e) {
        ...
        if (
            ...
            !(this.plugin.app.vault.adapter instanceof Pn.FileSystemAdapter)
        )
            this.cwd = "";
        else {
        ...
        for (let i of this.plugin.settings.templates_pairs) {
            ...
            !o ||
                ...
                (Pn.Platform.isMobile
                    ...
                    : ((a = await this.plugin.templater.parser.parse_commands(
                          a,
                          r,
                      )),
                      t.set(o, async (l) => {
                          let c = { ...process.env, ...l },
                              d = {
                                  timeout:
                                      this.plugin.settings.command_timeout *
                                      1e3,
                                  cwd: this.cwd,
                                  env: c,
...
var vi = class {
    constructor(e) {
        this.plugin = e;
        ((this.user_system_functions = new yi(e)),
            (this.user_script_functions = new ji(e)));
    }
    async generate_object(e) {
        let t = {},
            r = {};
...
var wi = class {
    constructor(e) {
        this.plugin = e;
        ((this.internal_functions = new xi(this.plugin)),
            (this.user_functions = new vi(this.plugin)));
    }
    async init() {
...
var Rt = class {
        ...
        set single_whitespace(e) {
            M.__wbg_set_parserconfig_single_whitespace(
                this.ptr,
                e.codePointAt(0),
            );
        }
        ...
        set multiple_whitespace(e) {
            M.__wbg_set_parserconfig_multiple_whitespace(
                this.ptr,
                e.codePointAt(0),
            );
        }
...
function zs() {
    ...
    return (
        ...
        (n.wbg.__wbindgen_string_get = function (e, t) {
            ...
            var o = Us(i)
                    ? 0
                    : gt(i, M.__wbindgen_malloc, M.__wbindgen_realloc),
                a = Re;
...
var cn = class {
    constructor(e) {
        this.plugin = e;
        ((this.functions_generator = new wi(this.plugin)),
            (this.parser = new ki()));
    }
    async setup() {
    ...
    async parse_template(e, t) {
        let r = await this.functions_generator.generate_object(
            e,
            Xe.USER_INTERNAL,
        );
        return (
    ...
    async create_new_note_from_template(e, t, r, i = !0) {
        ...
        if (
            ...
            (await this.plugin.app.vault.delete(a),
                await this.end_templater_task(l));
            return;
        }
        if (
            ...
            if (
                ...
                if (t) {
                    let { folder: r, format: i } = t.options,
                        o = (0, ln.normalizePath)(
                            `${r}/${(0, ln.moment)().format(i)}.md`,
                        ),
                        a = vt(this.plugin.app);
                    a?.path === o &&
                        cn.on_file_creation(this.templater, this.plugin.app, a);
                }
            }
        ...
        if ((this.remove_template_hotkey(e), t)) {
            ...
            (this.plugin.addCommand({
                ...
                callback: () => {
                    ...
                    !o ||
                        this.plugin.templater.append_template_to_active_file(o);
                },
            }),
                this.plugin.addCommand({
                    id: `create-${t}`,
...
var Di = class {
    ...
    async jump_to_next_cursor_location() {
        ...
        if (!i || !r) return;
        let o =
                e instanceof Ci.MarkdownView
                    ? e.currentMode.getFoldInfo()
                    : null,
            a = [];
        for (let l = r.length - 1; l >= 0; l--) {
            let c = r[l],
                d = this.get_editor_position_from_index(t, c.index),
                m = this.get_editor_position_from_index(
                    t,
                    c.index + c[0].length,
                );
        ...
        (e.editor.transaction({
            ...
            o &&
                ...
                (i.forEach((l) => {
                    o.folds = o.folds.filter(
                        (c) => c.from > l.line || c.to < l.line,
                    );
                }),
                e instanceof Ci.MarkdownView &&
...
`,
    ...
    get_cursor_matches_and_positions(e) {
        ...
        r.sort(
            (d, m) =>
                Number(d.groups?.order || 0) - Number(m.groups?.order || 0),
        );
        let i = r[0][0],
            o = r.filter((d) => d[0] === i),
            a = o[0][1] === "" ? [o[0]] : o,
...
`,
                ...
                tags: {
                    ...
                    examples: [
                        { name: "File tags", example: "<% tp.file.tags %>" },
                    ],
                },
                title: {
                    name: "title",
...
var Mi = class extends ea.EditorSuggest {
    constructor(e) {
        ...
        ((this.documentation = new Ni(e)),
            (this.intellisense_render_setting =
                e.settings.intellisense_render));
    }
    onTrigger(e, t, r) {
    ...
    renderSuggestion(e, t) {
        if ((t.createEl("b", { text: e.name }), Pi(e))) {
            if (
                ...
                let r = t.createEl("ol");
                for (let [i, o] of Object.entries(e.args))
                    Gr(r, i, o.description);
            }
            e.returns &&
                Fo(this.intellisense_render_setting) &&
                Gr(t, "Returns", e.returns);
        }
    ...
    selectSuggestion(e, t) {
        ...
        if (
            ...
            this.latest_trigger_info.start.ch ==
                this.latest_trigger_info.end.ch)
        ) {
...
(function (n) {
    ...
    (n.defineMode("javascript", function (e, t) {
        ...
        function O(s, p) {
            var A = s.next();
            if (A == '"' || A == "'")
                return ((p.tokenize = $(A)), p.tokenize(s, p));
            ...
            if (A == "#" && s.peek() == "!")
                return (s.skipToEnd(), E("meta", "meta"));
            if (A == "#" && s.eatWhile(d)) return E("variable", "property");
            if (
                (A == "<" && s.match("!--")) ||
                (A == "-" &&
                    s.match("->") &&
                    !/\S/.test(s.string.slice(0, s.start)))
            )
        ...
        function _e(s, p) {
            if (p)
                if (p.block) {
                    ...
                    return Ie(s, p.vars)
                        ? p
                        : new Ye(p.prev, new ke(s, p.vars), !1);
            else return null;
        }
        function xe(s) {
            return (
        ...
        function On(s) {
            if (s == "}")
                return ((h.marked = "string-2"), (h.state.tokenize = D), f(St));
        }
        function Bn(s) {
        ...
        function Ct(s, p) {
            ...
            if (s == "variable" || h.style == "keyword") {
                if (((h.marked = "property"), p == "get" || p == "set"))
                    return f(Ln);
                var A;
                return (
                    c &&
                ...
                if (s == "number" || s == "string")
                    return (
                        (h.marked = o ? "property" : h.style + " property"),
                        f(Ge)
                    );
        ...
        function Li(s) {
            if (c && s == ":")
                return h.stream.match(/^\s*\w+\s+is\b/, !1)
                    ? f(W, oa, V)
                    : f(V);
        }
        function oa(s, p) {
        ...
        function V(s, p) {
            ...
            if (s == "variable" || p == "void")
                return ((h.marked = "type"), f(ot));
            if (p == "|" || p == "&") return f(V);
        ...
        function sa(s) {
            if (s == "}")
                return ((h.marked = "string-2"), (h.state.tokenize = D), f(Sr));
        }
        function Cr(s, p) {
        ...
        function $i(s, p) {
            if (s == "keyword b" && p == "else")
                return f(B("form", "else"), ee, N);
        }
        function Ki(s, p) {
        ...
        function at(s, p) {
            ...
            if (s == "variable" || h.style == "keyword")
                return ((h.marked = "property"), f(dn, at));
                    ...
                    : ve == "form" && A == "{"
                      ...
                      : ve == "form"
                        ...
                        : ve == "stat"
                          ...
                          : x.info == "switch" &&
                              !We &&
                              t.doubleIndentSwitch != !1
                            ? x.indented +
                              (/^(?:case|default)\b/.test(p) ? r : 2 * r)
                            : x.align
                              ? x.column + (We ? 0 : 1)
                              : x.indented + (We ? 0 : r);
            },
    ...
    n.customOverlayMode = function (e, t, r) {
        return {
            ...
            token: function (i, o) {
                return (
                    (i != o.streamSeen ||
                        Math.min(o.basePos, o.overlayPos) < i.start) &&
                        ((o.streamSeen = i),
                        (o.basePos = o.overlayPos = i.start)),
                    i.start == o.basePos &&
                    ...
                    o.baseCur &&
                        ...
                        ((o.overlayCur = o.overlayCur.replace(
                            "line-templater-inline",
                            "",
                        )),
                        (o.overlayCur +=
                            " line-background-HyperMD-codeblock-bg")),
                    o.overlayCur == null
                        ? o.baseCur
...
var ta = X(require("@codemirror/language")),
    ...
    Fi = class {
        constructor(e) {
            this.plugin = e;
            ((this.cursor_jumper = new Di(e.app)),
                (this.activeEditorExtensions = []));
        }
        desktopShouldHighlight() {
            return (
                Oi.Platform.isDesktopApp &&
                this.plugin.settings.syntax_highlighting
            );
        }
        mobileShouldHighlight() {
            return (
                Oi.Platform.isMobile &&
                this.plugin.settings.syntax_highlighting_mobile
            );
        }
        async setup() {
            ((this.autocomplete = new Mi(this.plugin)),
                ...
                (this.desktopShouldHighlight() ||
                    this.mobileShouldHighlight()) &&
            ...
            window.CodeMirror.defineMode(ra, function (r) {
                let i = {
                    ...
                    blankLine: function (o) {
                        return o.inCommand
                            ? "line-background-templater-command-bg"
                            : null;
                    },
                    token: function (o, a) {
                        if (
                            (o.sol() && a.inCommand && (a.freeLine = !0),
                            a.inCommand)
                        ) {
                            let c = "";
                            if (o.match(/[-_]{0,1}%>/, !0)) {
