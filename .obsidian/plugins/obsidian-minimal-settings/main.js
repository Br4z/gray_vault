...
var p = (n, t, s) =>
    new Promise((l, d) => {
        var f = (h) => {
            ...
            m = (h) =>
                h.done ? l(h.value) : Promise.resolve(h.value).then(f, g);
        ...
        display() {
            ...
            (d.appendChild(
                ...
                new a.Setting(t)
                    ...
                    .setDesc(
                        "Level of contrast between sidebar and main content.",
                    )
                    .addDropdown((i) =>
                        i
            ...
            let g = t
                .createEl("div", { cls: "setting-item setting-item-heading" })
                .createEl("div", { cls: "setting-item-info" });
            g.createEl("div", { text: "Features", cls: "setting-item-name" });
            let m = g.createEl("div", { cls: "setting-item-description" });
            (m.appendChild(createEl("span", { text: "See " })),
                m.appendChild(
                    createEl("a", {
                        text: "documentation",
                ...
                m.appendText(" for details."),
                new a.Setting(t)
                    .setName("Text labels for primary navigation")
                    .setDesc(
                        "Navigation items in the left sidebar uses text labels.",
                    )
                    .addToggle((i) =>
                        i
                            .setValue(this.plugin.settings.labeledNav)
                            .onChange((e) => {
                ...
                new a.Setting(t)
                    ...
                    .addToggle((i) =>
                        i
                            .setValue(this.plugin.settings.colorfulFrame)
                            .onChange((e) => {
                ...
                new a.Setting(t)
                    ...
                    .setDesc(
                        "Active file and menu items use your accent color.",
                    )
                    .addToggle((i) =>
                        i
                ...
                new a.Setting(t)
                    ...
                    .addToggle((i) =>
                        i
                            .setValue(this.plugin.settings.minimalStatus)
                            .onChange((e) => {
                ...
                new a.Setting(t)
                    ...
                    .addToggle((i) =>
                        i
                            .setValue(this.plugin.settings.trimNames)
                            .onChange((e) => {
                ...
                new a.Setting(t)
                    ...
                    .setDesc(
                        "Display divider lines between workspace elements.",
                    )
                    .addToggle((i) =>
                        i
                            .setValue(this.plugin.settings.bordersToggle)
                            .onChange((e) => {
            ...
            let o = t
                .createEl("div", { cls: "setting-item setting-item-heading" })
                .createEl("div", { cls: "setting-item-info" });
            o.createEl("div", { text: "Layout", cls: "setting-item-name" });
            ...
            (r.appendChild(
                ...
                new a.Setting(t)
                    ...
                    .addToggle((i) =>
                        i
                            .setValue(this.plugin.settings.imgGrid)
                            .onChange((e) => {
                ...
                new a.Setting(t)
                    ...
                    .setDesc(
                        "Used for text in the sidebars and tabs (default 13).",
                    )
                    .addText((i) =>
                        i
                            .setPlaceholder("13")
                            .setValue(
                                (this.plugin.settings.textSmall || "") + "",
                            )
                            .onChange((e) => {
                                ((this.plugin.settings.textSmall =
                                    parseFloat(e)),
                ...
                new a.Setting(t)
                    ...
                    .addText((i) =>
                        i
                            ...
                            .onChange((e) => {
                                ((this.plugin.settings.lineWidth = parseInt(
                                    e.trim(),
                                )),
                                    this.plugin.saveData(this.plugin.settings),
                                    this.plugin.refresh());
                ...
                new a.Setting(t)
                    ...
                    .addText((i) =>
                        i
                            .setPlaceholder("50")
                            .setValue(
                                (this.plugin.settings.lineWidthWide || "") + "",
                            )
                            .onChange((e) => {
                                ((this.plugin.settings.lineWidthWide = parseInt(
                                    e.trim(),
                                )),
                                    this.plugin.saveData(this.plugin.settings),
                                    this.plugin.refresh());
                ...
                new a.Setting(t)
                    ...
                    .addText((i) =>
                        i
                            ...
                            .onChange((e) => {
                                ((this.plugin.settings.maxWidth = parseInt(
                                    e.trim(),
                                )),
                                    this.plugin.saveData(this.plugin.settings),
                                    this.plugin.refresh());
                ...
                new a.Setting(t)
                    ...
                    .addText((i) =>
                        i
                            .setPlaceholder("")
                            .setValue(
                                (this.plugin.settings.editorFont || "") + "",
                            )
                            .onChange((e) => {
...
var S = class extends C.Plugin {
            ...
            let t = () => {
                ...
                s = () => {
                    ...
                    this.settings.lightStyle == "minimal-light-contrast"
                        ...
                        : i &&
                          e &&
                          (i.removeClass("theme-dark"),
                          e.removeClass("theme-dark"));
                };
                ...
                this.addCommand({
                    ...
                    callback: () => {
                        ((this.settings.darkStyle =
                            d[
                                (d.indexOf(this.settings.darkStyle) + 1) %
                                    d.length
                            ]),
                            this.saveData(this.settings),
                ...
                this.addCommand({
                    ...
                    callback: () => {
                        ((this.settings.lightStyle =
                            l[
                                (l.indexOf(this.settings.lightStyle) + 1) %
                                    l.length
                            ]),
                            this.saveData(this.settings),
                ...
                this.addCommand({
                    ...
                    callback: () => {
                        ((this.settings.tableWidth =
                            g[
                                (g.indexOf(this.settings.tableWidth) + 1) %
                                    g.length
                            ]),
                            this.saveData(this.settings),
                            this.refresh());
                ...
                this.addCommand({
                    ...
                    callback: () => {
                        ((this.settings.imgWidth =
                            h[
                                (h.indexOf(this.settings.imgWidth) + 1) %
                                    h.length
                            ]),
                            this.saveData(this.settings),
                            this.refresh());
                ...
                this.addCommand({
                    ...
                    callback: () => {
                        ((this.settings.iframeWidth =
                            m[
                                (m.indexOf(this.settings.iframeWidth) + 1) %
                                    m.length
                            ]),
                            this.saveData(this.settings),
                            this.refresh());
                ...
                this.addCommand({
                    ...
                    callback: () => {
                        ((this.settings.chartWidth =
                            r[
                                (r.indexOf(this.settings.chartWidth) + 1) %
                                    r.length
                            ]),
                            this.saveData(this.settings),
                            this.refresh());
                ...
                this.addCommand({
                    ...
                    callback: () => {
                        ((this.settings.mapWidth =
                            o[
                                (o.indexOf(this.settings.mapWidth) + 1) %
                                    o.length
                            ]),
                            this.saveData(this.settings),
                            this.refresh());
    ...
    updateStyle() {
        (this.removeStyle(),
            ...
            document.body.classList.toggle(
                "labeled-nav",
                this.settings.labeledNav,
            ),
            document.body.classList.toggle(
                "minimal-folding",
                this.settings.folding,
            ),
            document.body.addClass(
                this.settings.chartWidth,
                this.settings.tableWidth,
