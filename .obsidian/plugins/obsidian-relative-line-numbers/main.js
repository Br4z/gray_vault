...
var absoluteLineNumberGutter = (0, import_view.gutter)({
    lineMarker: (view, line) => {
        ...
        const absoluteLineNo = new Marker(
            lineNo.toString().padStart(charLength, " "),
        );
...
function relativeLineNumbers(lineNo, state) {
    ...
    if (lineNo === cursorLine) {
        ...
        return (Math.abs(cursorLine - lineNo) - foldedCount)
            .toString()
            .padStart(charLength, " ");
    }
}
var showLineNumbers = relativeLineNumberGutter.of(
    (0, import_view.lineNumbers)({ formatNumber: relativeLineNumbers }),
);
var lineNumbersUpdateListener = import_view.EditorView.updateListener.of(
    (viewUpdate) => {
