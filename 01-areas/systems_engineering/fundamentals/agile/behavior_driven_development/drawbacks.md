...
BDD depends on clearly specified requirements expressed as concrete behaviors, so if requirements are vague or incomplete, the scenarios become unclear and BDD may not be effective.

Finally, even though the language is non-technical, testers using BDD still need sufficient technical skills to connect scenarios to automation and keep the suite maintainable.
