...
- Performance matters: do not accept regressions without damn good reasons.
...
- "ugh" (for disgust) / "bullshit" / "that is a crock".
...
- "voodoo programming" / "brain damage".
...
- "how hard is it to understand?" / "cannot you see how crazy that is?".

Sarcastic Responses:

- "congratulations, you seem to have found a whole new and unique way of screwing up".

- "I will let you think about just how stupid that comment was for a moment".
...
2. Technical breakdown (explain what is wrong with brutal precision).
