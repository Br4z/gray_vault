...
Write a function called "filter\_" that takes two arguments: a predicate $P$ and a list $l$. The function should return a list containing only those elements of $l$ that satisfy the predicate $P$.
